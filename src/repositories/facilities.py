...
from src.repositories.mapper.mappers import FacilitiesDataMapper
...
class RoomsFacilitiesRepository(BaseRepository):
    ...
    async def set_room_facilities(self, room_id: int, facolities_ids: list[int]):
        ...
        current_facilities_id: list[int] = res.scalars().all()
        ids_to_delete: list[int] = list(set(current_facilities_id) - set(facolities_ids))
        ids_to_insert: list[int] = list(set(facolities_ids) - set(current_facilities_id))
